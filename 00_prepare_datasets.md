...
``` r
if(all(file.exists(c("cache/endia_virscan_metadata.rds", "cache/endia_virscan_metadata_w_extra_ctrls.rds")))){
  endia_virscan_metadata <- read_rds("cache/endia_virscan_metadata.rds")
  endia_virscan_metadata_w_controls_that_seroconverted <- read_rds("cache/endia_virscan_metadata_w_extra_ctrls.rds")
} else {
  #1.
