...
ggsave("figures/endia_combined_rpk_and_samples_genera_plot.svg", endia_combined_rpk_and_samples_genera_plot, width = 15, height = 10)
```
...
```{r, echo = FALSE}
ggsave("figures/vigr_combined_rpk_and_samples_genera_plot.png", vigr_combined_rpk_and_samples_genera_plot, width = 15, height = 10)
ggsave("figures/vigr_combined_rpk_and_samples_genera_plot.svg", vigr_combined_rpk_and_samples_genera_plot, width = 15, height = 10)
```
