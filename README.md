...
[![](https://img.shields.io/badge/10.2337/db25--0805-yellow.svg?label=https%3A%2F%2Fdoi.org%2F&labelColor=navy)](https://doi.org/10.2337/db25-0805)
...
autoimmunity” which examined antigens identified by VirScan in two
Australian paediatric cohorts, Viruses In the Genetically at Risk (VIGR)
and Environmental Determinants of Islet Autoimmunity (ENDIA) by
[Delgado-Corrales & Fingerhut et
al. 2026](https://doi.org/10.2337/db25-0805). Please cite our paper if
you use any of the code or methods we used in this repository.
...
- [Supplementary Table 03 and 04 and Supplementary Fig. 7: GLMM results
  for 3D and VP1 motif enrichment for each
  cohort](08_GLMMs_on_EV_motifs.md)
